    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card card-statistics">
                <div class="card-body">
                    <form action="{{ route('recipe-items.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="any" class="form-control" id="price" placeholder="Recipe price" name="price" value="{{ old('price') }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control summernote" id="recipe_information" placeholder="Write some text..."
                                name="recipe_information">{{ old('recipe_information') }}</textarea>
                        </div>
